...
if("TRUE" STREQUAL "TRUE")
  set(mrsim_SOURCE_PREFIX /home/lorenzo/Scrivania/robot-programming/exam/rp_ws/src/mrsim)
  set(mrsim_DEVEL_PREFIX /home/lorenzo/Scrivania/robot-programming/exam/rp_ws/devel)
  set(mrsim_INSTALL_PREFIX "")
  set(mrsim_PREFIX ${mrsim_DEVEL_PREFIX})
else()
  set(mrsim_SOURCE_PREFIX "")
  set(mrsim_DEVEL_PREFIX "")
  set(mrsim_INSTALL_PREFIX /home/lorenzo/Scrivania/robot-programming/exam/rp_ws/install)
...
if(NOT "/home/lorenzo/Scrivania/robot-programming/exam/rp_ws/devel/include;/home/lorenzo/Scrivania/robot-programming/exam/rp_ws/src/mrsim/include/ " STREQUAL " ")
  set(mrsim_INCLUDE_DIRS "")
  set(_include_dirs "/home/lorenzo/Scrivania/robot-programming/exam/rp_ws/devel/include;/home/lorenzo/Scrivania/robot-programming/exam/rp_ws/src/mrsim/include/")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Lorenzo Ciarpaglini <ciarpaglini.1813738@studenti.uniroma1.it>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrsim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lorenzo/Scrivania/robot-programming/exam/rp_ws/src/mrsim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lorenzo/Scrivania/robot-programming/exam/rp_ws/devel/lib;/opt/ros/noetic/lib)
...
set(mrsim_EXPORTED_TARGETS "mrsim_generate_messages_cpp;mrsim_generate_messages_eus;mrsim_generate_messages_lisp;mrsim_generate_messages_nodejs;mrsim_generate_messages_py")
...
set(depends "message_runtime;roscpp;tf2;tf2_ros;tf2_eigen")
...
set(pkg_cfg_extras "mrsim-msg-extras.cmake")
